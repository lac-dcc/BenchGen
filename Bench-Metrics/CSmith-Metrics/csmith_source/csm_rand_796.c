...
static int32_t g_5 = 0xD4081C29L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_8 = 0x6D7BE7E5L;
    int32_t *l_9[4];
    int16_t l_10[7] = {0L,0L,0L,0L,0L,0L,0L};
    uint32_t l_12[5] = {4294967293UL,4294967293UL,4294967293UL,4294967293UL,4294967293UL};
    int i;
    for (i = 0; i < 4; i++)
        l_9[i] = (void*)0;
lbl_11:
