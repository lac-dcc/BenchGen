...
Array func4(ArrayParam* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 2) {
         ...
         Array array77 = func11(&params0, loopsFactor);
         free(params0.data);
         array77.refC--;
         if(array77.refC == 0) {
            free(array77.data);
      ...
      params0.data[0] = array74;
      params0.data[1] = array75;
      Array array78 = func8(&params0, rng(), loopsFactor);
      free(params0.data);
      ...
      Array array79 = func5(&params1, rng(), loopsFactor);
      free(params1.data);
      array79.refC--;
      if(array79.refC == 0) {
         free(array79.data);
      ...
      if(PATH0 & 4) {
         ...
         Array array83 = func11(&params0, loopsFactor);
         free(params0.data);
         array83.refC--;
         if(array83.refC == 0) {
            free(array83.data);
      ...
      params0.data[1] = array80;
      params0.data[2] = array81;
      Array array84 = func8(&params0, rng(), loopsFactor);
      free(params0.data);
      array84.refC--;
      if(array84.refC == 0) {
         free(array84.data);
   ...
   for(; loop35 < loopLimit35; loop35++) {
      ...
      if(PATH0 & 8) {
         ...
         Array array88 = func11(&params0, loopsFactor);
         free(params0.data);
         array88.refC--;
         if(array88.refC == 0) {
            free(array88.data);
      ...
      params0.data[1] = array85;
      params0.data[2] = array86;
      Array array89 = func8(&params0, rng(), loopsFactor);
      free(params0.data);
      array89.refC--;
      if(array89.refC == 0) {
         free(array89.data);
