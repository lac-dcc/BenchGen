...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x0FE1CA29L;
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[1][8][3] = {{{0x75L,0x64L,0x64L},{1UL,1UL,1UL},{0x75L,0x75L,0x64L},{0UL,1UL,0UL},{0x75L,0x64L,0x64L},{1UL,1UL,1UL},{0x75L,0x75L,0x64L},{0UL,1UL,0UL}}};
