...
static int32_t g_6 = 0x6B87D0FAL;
static int16_t g_10[4] = {(-1L),(-1L),(-1L),(-1L)};
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_8 = 0x51EBF0DDL;
    for (g_2[0] = 0; (g_2[0] > (-21)); g_2[0] = safe_sub_func_int32_t_s_s(g_2[0], 1))
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7[10] = {&g_6,&g_2[0],&g_6,&g_2[0],&g_6,&g_2[0],&g_6,&g_2[0],&g_6,&g_2[0]};
        int16_t l_9[1][1];
        int i, j;
        for (i = 0; i < 1; i++)
        {
