#ifndef CANGJIEVARIABLEGENERATOR_H
#define CANGJIEVARIABLEGENERATOR_H
#include <cstdlib>
#include <memory>
#include <string>
 ...
 */
class CangjieGeneratorArray : public GeneratorArray {
   public:
     ...
     */
    CangjieGeneratorArray(int totalSize, int id);
