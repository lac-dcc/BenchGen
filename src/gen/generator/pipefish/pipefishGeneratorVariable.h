#ifndef PIPEFISHVARIABLEGENERATOR_H
#define PIPEFISHVARIABLEGENERATOR_H
#include <cstdlib>
#include <memory>
#include <string>
...
class PipefishGeneratorSortedList : public GeneratorSortedList {
   public:
    PipefishGeneratorSortedList() {};

    PipefishGeneratorSortedList(int id);
 ...
 */
class PipefishGeneratorArray : public GeneratorArray {
   public:
     ...
     */
    PipefishGeneratorArray(int totalSize, int id);
