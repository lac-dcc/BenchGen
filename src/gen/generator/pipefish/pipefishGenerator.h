#ifndef PIPEFISHGENERATOR_H
#define PIPEFISHGENERATOR_H
#include <filesystem>
#include <fstream>
#include <iostream>
#include <sstream>
 ...
 */
class PipefishGenerator : public ProgrammingLanguageGenerator {
   private:
     ...
     */
    PipefishGenerator(std::string variableType) {
