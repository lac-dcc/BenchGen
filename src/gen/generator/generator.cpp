...
void Generator::generateMainFunction() {
    ...
    mainFunction.addLine({"int main(int argc, char** argv) {",
                          ...
                          "         printf(\"  -path-seed N      Set the random seed for control flow decisions (default: 0).\\n\");",
                          "         printf(\"  -loops-factor N   Set how many times each loop should iterate (default: 100).\\n\");",
                          "         printf(\"  -help             Display this help message.\\n\");",
                          "         return 0;",
                          "      } else if (strcmp(argv[i], \"-path-seed\") == 0) {",
                          "         i++;",
                          "         if (i < argc) {",
                          "            srand(atoi(argv[i]));",
                          "         } else {",
                          "            fprintf(stderr, \"Error: Missing argument for -path-seed!\\n\");",
                          "            return 1;",
                          "         }",
                          "      }",
                          ...
                          "         } else {",
                          "             fprintf(stderr, \"Error: Missing argument for -loops-factor!\\n\");",
                          "             return 1;",
                          "         }",
                          "      } else {",
                          "         fprintf(stderr, \"Warning: Unknown argument '%s'!\\n\", argv[i]);",
                          "         fprintf(stderr, \"Try %s -help for more help.\\n\", argv[0]);",
                          "      }",
                          "   }",
                          "   return 0;",
                          "}"});
