#ifndef PIPEFISHAST_H
#define PIPEFISHAST_H
 ...
 */
class PipefishStatementCode : public StatementCode {

   public:
    PipefishStatementCode(std::shared_ptr<Node> stmt, std::shared_ptr<Node> code) : StatementCode(stmt, code) {
    }
 ...
 */
class PipefishLambdaCode : public LambdaCode {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~PipefishLambdaCode() = default;
};
 ...
 */
class PipefishId : public Id {

   public:
    PipefishId(std::string id) : Id(id) {
    }
 ...
 */
class PipefishInsert : public Insert {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~PipefishInsert() = default;
};
 ...
 */
class PipefishRemove : public Remove {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~PipefishRemove() = default;
};
 ...
 */
class PipefishContains : public Contains {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~PipefishContains() = default;
};
 ...
 */
class PipefishLoop : public Loop {

   public:
    PipefishLoop(std::shared_ptr<Node> code) : Loop(code) {
    }
 ...
 */
class PipefishCall : public Call {
   ...
   ~PipefishCall(){};
    ...
    PipefishCall(int id, std::shared_ptr<Node> code) : Call(id, code) {}
 ...
 */
class PipefishSeq : public Seq {

   public:
    PipefishSeq(std::shared_ptr<Node> code) : Seq(code) {
    }
 ...
 */
class PipefishIf : public If {
  
   public:
    PipefishIf(std::shared_ptr<Node> c1, std::shared_ptr<Node> c2) : If(c1, c2) {
    }
