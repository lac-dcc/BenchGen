 ...
 */
class RustStatementCode : public StatementCode {

   public:
    RustStatementCode(std::shared_ptr<Node> stmt, std::shared_ptr<Node> code) : StatementCode(stmt, code) {
    }
 ...
 */
class RustLambdaCode : public LambdaCode {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~RustLambdaCode() = default;
};
 ...
 */
class RustId : public Id {

   public:
    RustId(std::string id) : Id(id) {
    }
 ...
 */
class RustInsert : public Insert {
   public:
    void gen(ProgrammingLanguageGenerator&) override;
 ...
 */
class RustRemove : public Remove {
   public:
    void gen(ProgrammingLanguageGenerator&) override;
 ...
 */
class RustContains : public Contains {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~RustContains() = default;
};
 ...
 */
class RustLoop : public Loop {

   public:
    RustLoop(std::shared_ptr<Node> code) : Loop(code) {
    }
...
class RustCall : public Call {
   ...
   ~RustCall(){};
    ...
    RustCall(int id, std::shared_ptr<Node> code) : Call(id, code) {}
 ...
 */
class RustSeq : public Seq {

   public:
    RustSeq(std::shared_ptr<Node> code) : Seq(code) {
    }
 ...
 */
class RustIf : public If {
  
   public:
    RustIf(std::shared_ptr<Node> c1, std::shared_ptr<Node> c2) : If(c1, c2) {
    }
