 ...
 */
class CangjieStatementCode : public StatementCode {

   public:
    CangjieStatementCode(std::shared_ptr<Node> stmt, std::shared_ptr<Node> code) : StatementCode(stmt, code) {
    }
 ...
 */
class CangjieLambdaCode : public LambdaCode {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~CangjieLambdaCode() = default;
};
 ...
 */
class CangjieId : public Id {

   public:
    CangjieId(std::string id) : Id(id) {
    }
 ...
 */
class CangjieInsert : public Insert {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~CangjieInsert() = default;
};
 ...
 */
class CangjieRemove : public Remove {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~CangjieRemove() = default;
};
 ...
 */
class CangjieContains : public Contains {
   public:
    void gen(ProgrammingLanguageGenerator&) override;

    void print(int indent) override;

    ~CangjieContains() = default;
};
 ...
 */
class CangjieLoop : public Loop {

   public:
    CangjieLoop(std::shared_ptr<Node> code) : Loop(code) {
    }
...
class CangjieCall : public Call {
   ...
   ~CangjieCall(){};
    ...
    CangjieCall(int id, std::shared_ptr<Node> code) : Call(id, code) {}
 ...
 */
class CangjieSeq : public Seq {

   public:
    CangjieSeq(std::shared_ptr<Node> code) : Seq(code) {
    }
 ...
 */
class CangjieIf : public If {
  
   public:
    CangjieIf(std::shared_ptr<Node> c1, std::shared_ptr<Node> c2) : If(c1, c2) {
    }
