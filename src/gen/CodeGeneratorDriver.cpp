...
int main(int argc, char const* argv[]) {
    if (argc < 7) {
        ...
        std::cout << "Please provide Number of Iterations, Production Rules, Seed String File, Output Folder Name, Variable Type and Program Target ." << std::endl;
        std::cout << "Usage: ./main <number_of_iterations> <production_rules_file> <seed_string_file> <bench_name> <var_type> <target>" << std::endl;
        return 1;
    }
