...
sortedlist_t* func10(sortedlist_t_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   if(PATH0 & 1) {
      ...
      for(; loop51 < loopLimit51; loop51++) {
         ...
         sortedlist126->refC--;
         if(sortedlist126->refC == 0 && sortedlist126->n > 0){
      ...
      free(params0.data);
      sortedlist127->refC--;
      if(sortedlist127->refC == 0 && sortedlist127->n > 0){
   ...
   free(params0.data);
   sortedlist125->refC--;
   if(sortedlist125->refC == 0 && sortedlist125->n > 0){
   ...
   sortedlist124->refC--;
   if(sortedlist124->refC == 0 && sortedlist124->n > 0){
