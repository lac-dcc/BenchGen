...
int main(int argc, char** argv) {
   ...
   for(; loop0 < loopLimit0; loop0++) {
      ...
      if(rng() & 1) {
            ...
            if(rng() & 1) {
               ...
               for(; loop2 < loopLimit2; loop2++) {
                  ...
                  if(rng() & 1) {
                     ...
                     free(params0.data);
                     sortedlist7->refC--;
                     if(sortedlist7->refC == 0 && sortedlist7->n > 0){
                  ...
                  sortedlist5->refC--;
                  if(sortedlist5->refC == 0 && sortedlist5->n > 0){
         ...
         free(params0.data);
         sortedlist40->refC--;
         if(sortedlist40->refC == 0 && sortedlist40->n > 0){
      ...
      if(rng() & 1) {
         ...
         for(; loop56 < loopLimit56; loop56++) {
            ...
            if(rng() & 1) {
               ...
               free(params0.data);
               sortedlist66->refC--;
               if(sortedlist66->refC == 0 && sortedlist66->n > 0){
            ...
            sortedlist67->refC--;
            if(sortedlist67->refC == 0 && sortedlist67->n > 0){
         ...
         free(params0.data);
         sortedlist68->refC--;
         if(sortedlist68->refC == 0 && sortedlist68->n > 0){
      ...
      for(; loop68 < loopLimit68; loop68++) {
            ...
            for(; loop69 < loopLimit69; loop69++) {
               ...
               if(rng() & 1) {
                  ...
                  for(; loop70 < loopLimit70; loop70++) {
                     ...
                     sortedlist81->refC--;
                     if(sortedlist81->refC == 0 && sortedlist81->n > 0){
                     ...
                     sortedlist80->refC--;
                     if(sortedlist80->refC == 0 && sortedlist80->n > 0){
               ...
               sortedlist79->refC--;
               if(sortedlist79->refC == 0 && sortedlist79->n > 0){
               ...
               sortedlist78->refC--;
               if(sortedlist78->refC == 0 && sortedlist78->n > 0){
         ...
         sortedlist77->refC--;
         if(sortedlist77->refC == 0 && sortedlist77->n > 0){
      ...
      sortedlist70->refC--;
      if(sortedlist70->refC == 0 && sortedlist70->n > 0){
      ...
      sortedlist69->refC--;
      if(sortedlist69->refC == 0 && sortedlist69->n > 0){
