...
int main(int argc, char** argv) {
   ...
   for(; loop0 < loopLimit0; loop0++) {
      ...
      if(rng() & 1) {
         ...
         for(; loop1 < loopLimit1; loop1++) {
            ...
            if(rng() & 1) {
               ...
               for(; loop2 < loopLimit2; loop2++) {
                  ...
                  sortedlist3->refC--;
                  if(sortedlist3->refC == 0 && sortedlist3->n > 0){
               ...
               free(params0.data);
               sortedlist4->refC--;
               if(sortedlist4->refC == 0 && sortedlist4->n > 0){
            ...
            sortedlist6->refC--;
            if(sortedlist6->refC == 0 && sortedlist6->n > 0){
            ...
            sortedlist2->refC--;
            if(sortedlist2->refC == 0 && sortedlist2->n > 0){
            ...
            sortedlist1->refC--;
            if(sortedlist1->refC == 0 && sortedlist1->n > 0){
         ...
         free(params0.data);
         sortedlist24->refC--;
         if(sortedlist24->refC == 0 && sortedlist24->n > 0){
      ...
      if(rng() & 1) {
         ...
         for(; loop43 < loopLimit43; loop43++) {
            ...
            if(rng() & 1) {
               ...
               for(; loop44 < loopLimit44; loop44++) {
                  ...
                  sortedlist47->refC--;
                  if(sortedlist47->refC == 0 && sortedlist47->n > 0){
               ...
               free(params0.data);
               sortedlist48->refC--;
               if(sortedlist48->refC == 0 && sortedlist48->n > 0){
            ...
            sortedlist49->refC--;
            if(sortedlist49->refC == 0 && sortedlist49->n > 0){
            ...
            sortedlist46->refC--;
            if(sortedlist46->refC == 0 && sortedlist46->n > 0){
            ...
            sortedlist45->refC--;
            if(sortedlist45->refC == 0 && sortedlist45->n > 0){
         ...
         free(params0.data);
         sortedlist50->refC--;
         if(sortedlist50->refC == 0 && sortedlist50->n > 0){
      ...
      if(rng() & 1) {
         ...
         free(params0.data);
         sortedlist53->refC--;
         if(sortedlist53->refC == 0 && sortedlist53->n > 0){
      ...
      for(; loop55 < loopLimit55; loop55++) {
         ...
         sortedlist56->refC--;
         if(sortedlist56->refC == 0 && sortedlist56->n > 0){
         ...
         sortedlist55->refC--;
         if(sortedlist55->refC == 0 && sortedlist55->n > 0){
      ...
      if(rng() & 1) {
         ...
         for(; loop57 < loopLimit57; loop57++) {
            ...
            sortedlist59->refC--;
            if(sortedlist59->refC == 0 && sortedlist59->n > 0){
            ...
            sortedlist58->refC--;
            if(sortedlist58->refC == 0 && sortedlist58->n > 0){
         ...
         free(params1.data);
         sortedlist60->refC--;
         if(sortedlist60->refC == 0 && sortedlist60->n > 0){
      ...
      for(; loop80 < loopLimit80; loop80++) {
         ...
         if(rng() & 1) {
            ...
            for(; loop81 < loopLimit81; loop81++) {
               ...
               sortedlist84->refC--;
               if(sortedlist84->refC == 0 && sortedlist84->n > 0){
               ...
               sortedlist83->refC--;
               if(sortedlist83->refC == 0 && sortedlist83->n > 0){
            ...
            free(params2.data);
            sortedlist85->refC--;
            if(sortedlist85->refC == 0 && sortedlist85->n > 0){
         ...
         if(rng() & 1) {
            ...
            for(; loop116 < loopLimit116; loop116++) {
               ...
               if(rng() & 1) {
                  ...
                  for(; loop117 < loopLimit117; loop117++) {
                     ...
                     sortedlist120->refC--;
                     if(sortedlist120->refC == 0 && sortedlist120->n > 0){
                  ...
                  free(params3.data);
                  sortedlist121->refC--;
                  if(sortedlist121->refC == 0 && sortedlist121->n > 0){
               ...
               sortedlist122->refC--;
               if(sortedlist122->refC == 0 && sortedlist122->n > 0){
               ...
               sortedlist119->refC--;
               if(sortedlist119->refC == 0 && sortedlist119->n > 0){
               ...
               sortedlist118->refC--;
               if(sortedlist118->refC == 0 && sortedlist118->n > 0){
            ...
            free(params3.data);
            sortedlist123->refC--;
            if(sortedlist123->refC == 0 && sortedlist123->n > 0){
         ...
         sortedlist117->refC--;
         if(sortedlist117->refC == 0 && sortedlist117->n > 0){
         ...
         sortedlist86->refC--;
         if(sortedlist86->refC == 0 && sortedlist86->n > 0){
         ...
         sortedlist82->refC--;
         if(sortedlist82->refC == 0 && sortedlist82->n > 0){
      ...
      sortedlist65->refC--;
      if(sortedlist65->refC == 0 && sortedlist65->n > 0){
      ...
      sortedlist57->refC--;
      if(sortedlist57->refC == 0 && sortedlist57->n > 0){
      ...
      sortedlist54->refC--;
      if(sortedlist54->refC == 0 && sortedlist54->n > 0){
      ...
      sortedlist51->refC--;
      if(sortedlist51->refC == 0 && sortedlist51->n > 0){
      ...
      sortedlist44->refC--;
      if(sortedlist44->refC == 0 && sortedlist44->n > 0){
      ...
      sortedlist0->refC--;
      if(sortedlist0->refC == 0 && sortedlist0->n > 0){
