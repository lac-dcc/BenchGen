   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 4) {
         ...
         for(; loop52 < loopLimit52; loop52++) {
            ...
            sortedlist131->refC--;
            if(sortedlist131->refC == 0 && sortedlist131->n > 0){
         ...
         free(params0.data);
         sortedlist132->refC--;
         if(sortedlist132->refC == 0 && sortedlist132->n > 0){
      ...
      free(params0.data);
      sortedlist133->refC--;
      if(sortedlist133->refC == 0 && sortedlist133->n > 0){
      ...
      sortedlist130->refC--;
      if(sortedlist130->refC == 0 && sortedlist130->n > 0){
      ...
      sortedlist129->refC--;
      if(sortedlist129->refC == 0 && sortedlist129->n > 0){
   ...
   for(; loop53 < loopLimit53; loop53++) {
      ...
      if(PATH0 & 8) {
         ...
         for(; loop54 < loopLimit54; loop54++) {
            ...
            sortedlist136->refC--;
            if(sortedlist136->refC == 0 && sortedlist136->n > 0){
         ...
         free(params0.data);
         sortedlist137->refC--;
         if(sortedlist137->refC == 0 && sortedlist137->n > 0){
      ...
      free(params0.data);
      sortedlist138->refC--;
      if(sortedlist138->refC == 0 && sortedlist138->n > 0){
      ...
      sortedlist135->refC--;
      if(sortedlist135->refC == 0 && sortedlist135->n > 0){
      ...
      sortedlist134->refC--;
      if(sortedlist134->refC == 0 && sortedlist134->n > 0){
