...
sortedlist_t* func3(sortedlist_t_param* vars, const unsigned long PATH0, int loopsFactor) {
   ...
   if(PATH0 & 1) {
      ...
      for(; loop56 < loopLimit56; loop56++) {
         sortedlist_t* sortedlist142;
         if (pCounter > 0) {
            sortedlist142 = vars->data[--pCounter];
            sortedlist142->refC++;
         } else {
              sortedlist142 = (sortedlist_t*)malloc(sizeof(sortedlist_t));
              sortedlist142->refC = 1;
              sortedlist142->n = 0;
         ...
         sortedlist142->refC--;
         if(sortedlist142->refC == 0 && sortedlist142->n > 0){
      ...
      free(params0.data);
      sortedlist143->refC--;
      if(sortedlist143->refC == 0 && sortedlist143->n > 0){
   ...
   free(params0.data);
   sortedlist144->refC--;
   if(sortedlist144->refC == 0 && sortedlist144->n > 0){
   ...
   sortedlist140->refC--;
   if(sortedlist140->refC == 0 && sortedlist140->n > 0){
