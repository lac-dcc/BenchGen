...
int main(int argc, char** argv) {
   ...
   for(; loop0 < loopLimit0; loop0++) {
      ...
      if(rng() & 1) {
         ...
         for(; loop57 < loopLimit57; loop57++) {
            ...
            sortedlist146->refC--;
            if(sortedlist146->refC == 0 && sortedlist146->n > 0){
         ...
         free(params3.data);
         sortedlist147->refC--;
         if(sortedlist147->refC == 0 && sortedlist147->n > 0){
      ...
      sortedlist154->refC--;
      if(sortedlist154->refC == 0 && sortedlist154->n > 0){
      ...
      sortedlist145->refC--;
      if(sortedlist145->refC == 0 && sortedlist145->n > 0){
      ...
      sortedlist139->refC--;
      if(sortedlist139->refC == 0 && sortedlist139->n > 0){
   ...
   if(rng() & 1) {
      ...
      sortedlist171->refC--;
      if(sortedlist171->refC == 0 && sortedlist171->n > 0){
   ...
   free(params0.data);
   sortedlist172->refC--;
   if(sortedlist172->refC == 0 && sortedlist172->n > 0){
