...
int main() {
   ...
   if(rng() & 1) {
      ...
      if(rng() & 1) {
         ...
         int loop168 = 0;
         int loopLimit168 = (rand()%10)/1 + 1;;
         for(; loop168 < loopLimit168; loop168++) {
            int scalar4 = 1;
            scalar1++;
            int loop169 = 0;
            int loopLimit169 = (rand()%10)/2 + 1;;
               ...
               if(rng() & 1) {
                  ...
                  if(rng() & 1) {
                     ...
                     for(; loop187 < loopLimit187; loop187++) {
                        ...
                        scalar4++;
                        int loop188 = 0;
                        int loopLimit188 = (rand()%10)/4 + 1;;
                        for(; loop188 < loopLimit188; loop188++) {
                           int loop189 = 0;
                           int loopLimit189 = (rand()%10)/5 + 1;;
            ...
            if(rng() & 1) {
               ...
               if(rng() & 1) {
                  ...
                  int loop217 = 0;
                  int loopLimit217 = (rand()%10)/2 + 1;;
                  for(; loop217 < loopLimit217; loop217++) {
                     int scalar8 = 1;
                     scalar2++;
                     int loop218 = 0;
                     int loopLimit218 = (rand()%10)/3 + 1;;
         ...
         for(; loop221 < loopLimit221; loop221++) {
               ...
               if(rng() & 1) {
                  ...
                  if(rng() & 1) {
                     ...
                     for(; loop226 < loopLimit226; loop226++) {
                        ...
                        scalar5++;
                        int loop227 = 0;
                        int loopLimit227 = (rand()%10)/4 + 1;;
                        for(; loop227 < loopLimit227; loop227++) {
                           int loop228 = 0;
                           int loopLimit228 = (rand()%10)/5 + 1;;
            ...
            if(rng() & 1) {
               ...
               if(rng() & 1) {
                  ...
                  int loop237 = 0;
                  int loopLimit237 = (rand()%10)/2 + 1;;
                  for(; loop237 < loopLimit237; loop237++) {
                     int scalar8 = 1;
                     scalar6++;
                     int loop238 = 0;
                     int loopLimit238 = (rand()%10)/3 + 1;;
      ...
      if(rng() & 1) {
         ...
         if(rng() & 1) {
            ...
            for(; loop327 < loopLimit327; loop327++) {
               ...
               scalar2++;
               int loop328 = 0;
               int loopLimit328 = (rand()%10)/3 + 1;;
               for(; loop328 < loopLimit328; loop328++) {
                  int loop329 = 0;
                  int loopLimit329 = (rand()%10)/4 + 1;;
   ...
   if(rng() & 1) {
      ...
      if(rng() & 1) {
         ...
         int loop377 = 0;
         int loopLimit377 = (rand()%10)/1 + 1;;
         for(; loop377 < loopLimit377; loop377++) {
            int scalar7 = 1;
            scalar2++;
            int loop378 = 0;
            int loopLimit378 = (rand()%10)/2 + 1;;
            for(; loop378 < loopLimit378; loop378++) {
               int loop379 = 0;
               int loopLimit379 = (rand()%10)/3 + 1;;
   ...
   for(; loop455 < loopLimit455; loop455++) {
      ...
      for(; loop456 < loopLimit456; loop456++) {
         ...
         for(; loop457 < loopLimit457; loop457++) {
            int loop458 = 0;
            int loopLimit458 = (rand()%10)/4 + 1;;
            for(; loop458 < loopLimit458; loop458++) {
               int loop459 = 0;
               int loopLimit459 = (rand()%10)/5 + 1;;
      ...
      if(PATH0 & -2147483648) {
         ...
         for(; loop78 < loopLimit78; loop78++) {
            ...
            for(; loop79 < loopLimit79; loop79++) {
               int loop80 = 0;
               int loopLimit80 = (rand()%10)/3 + 1;;
               for(; loop80 < loopLimit80; loop80++) {
                  int loop81 = 0;
                  int loopLimit81 = (rand()%10)/4 + 1;;
...
void func11(const unsigned long PATH0) {
   ...
   for(; loop276 < loopLimit276; loop276++) {
      ...
      for(; loop277 < loopLimit277; loop277++) {
         int loop278 = 0;
         int loopLimit278 = (rand()%10)/5 + 1;;
         for(; loop278 < loopLimit278; loop278++) {
            int loop279 = 0;
            int loopLimit279 = (rand()%10)/6 + 1;;
...
void func4(const unsigned long PATH0) {
         ...
         for(; loop406 < loopLimit406; loop406++) {
               ...
               if(PATH0 & 32) {
                  ...
                  if(PATH0 & 64) {
                     ...
                     for(; loop411 < loopLimit411; loop411++) {
                        ...
                        scalar9++;
                        int loop412 = 0;
                        int loopLimit412 = (rand()%10)/4 + 1;;
                        for(; loop412 < loopLimit412; loop412++) {
                           int loop413 = 0;
                           int loopLimit413 = (rand()%10)/5 + 1;;
            ...
            if(PATH0 & 524288) {
               ...
               if(PATH0 & 1048576) {
                  ...
                  int loop422 = 0;
                  int loopLimit422 = (rand()%10)/2 + 1;;
                  for(; loop422 < loopLimit422; loop422++) {
                     int scalar11 = 1;
                     scalar10++;
                     int loop423 = 0;
                     int loopLimit423 = (rand()%10)/3 + 1;;
                     for(; loop423 < loopLimit423; loop423++) {
                        int loop424 = 0;
                        int loopLimit424 = (rand()%10)/4 + 1;;
            ...
            if(PATH0 & 134217728) {
               ...
               if(PATH0 & 268435456) {
                  ...
                  int loop428 = 0;
                  int loopLimit428 = (rand()%10)/2 + 1;;
                  for(; loop428 < loopLimit428; loop428++) {
                     int scalar11 = 1;
                     scalar6++;
                     int loop429 = 0;
                     int loopLimit429 = (rand()%10)/3 + 1;;
   ...
   if(PATH0 & -2147483648) {
      ...
      if(PATH0 & -2147483648) {
         ...
         int loop445 = 0;
         int loopLimit445 = (rand()%10)/1 + 1;;
         for(; loop445 < loopLimit445; loop445++) {
            int scalar7 = 1;
            scalar6++;
            int loop446 = 0;
            int loopLimit446 = (rand()%10)/2 + 1;;
   ...
   if(PATH0 & -2147483648) {
      ...
      if(PATH0 & -2147483648) {
         ...
         int loop451 = 0;
         int loopLimit451 = (rand()%10)/1 + 1;;
         for(; loop451 < loopLimit451; loop451++) {
            int scalar7 = 1;
            scalar7++;
            int loop452 = 0;
            int loopLimit452 = (rand()%10)/2 + 1;;
...
void func5(const unsigned long PATH0) {
   ...
   for(; loop461 < loopLimit461; loop461++) {
      int loop462 = 0;
      int loopLimit462 = (rand()%10)/3 + 1;;
      for(; loop462 < loopLimit462; loop462++) {
         int loop463 = 0;
         int loopLimit463 = (rand()%10)/4 + 1;;
         for(; loop463 < loopLimit463; loop463++) {
            int loop464 = 0;
            int loopLimit464 = (rand()%10)/5 + 1;;
            for(; loop464 < loopLimit464; loop464++) {
               int loop465 = 0;
               int loopLimit465 = (rand()%10)/6 + 1;;
      ...
      if(PATH0 & 524288) {
         ...
         if(PATH0 & 1048576) {
            ...
            for(; loop479 < loopLimit479; loop479++) {
               ...
               scalar7++;
               int loop480 = 0;
               int loopLimit480 = (rand()%10)/4 + 1;;
               for(; loop480 < loopLimit480; loop480++) {
                  int loop481 = 0;
                  int loopLimit481 = (rand()%10)/5 + 1;;
         ...
         for(; loop490 < loopLimit490; loop490++) {
            ...
            if(PATH0 & -2147483648) {
               ...
               if(PATH0 & -2147483648) {
                  ...
                  int loop499 = 0;
                  int loopLimit499 = (rand()%10)/3 + 1;;
                  for(; loop499 < loopLimit499; loop499++) {
                     int scalar15 = 1;
                     scalar8++;
                     int loop500 = 0;
                     int loopLimit500 = (rand()%10)/4 + 1;;
   ...
   if(PATH0 & -2147483648) {
      ...
      if(PATH0 & -2147483648) {
         ...
         for(; loop503 < loopLimit503; loop503++) {
            ...
            scalar6++;
            int loop504 = 0;
            int loopLimit504 = (rand()%10)/3 + 1;;
            for(; loop504 < loopLimit504; loop504++) {
               int loop505 = 0;
               int loopLimit505 = (rand()%10)/4 + 1;;
