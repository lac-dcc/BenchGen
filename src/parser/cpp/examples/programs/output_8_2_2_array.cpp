   ...
   if(rng() & 1) {
      if(rng() & 1) {
         ...
         for(int scalar0 = 0; scalar0 < 10; scalar0++) {
            ...
            int* array1 = new int[348];
            scalar0++;
            int* array2 = new int[659];
            scalar0--;
            ...
            if(rng() & 1) {
               ...
               int* array4 = new int[342];
               if(rng() & 1) {
                  func11();
               }
               else {
                  for(int scalar5 = 0; scalar5 < 10; scalar5++) {
                     int* array6 = new int[587];
                     scalar0++;
                     int* array7 = new int[301];
                     for (int i = 0; i < 348; i++) {
                        array1[i]--; 
                     }
                     int* array8 = new int[372];
                     for (int i = 0; i < 342; i++) {
                        array4[i]++; 
                     }
                     if(rng() & 1) {
                        ...
                        if(rng() & 1) {
                           ...
                           for(int scalar10 = 0; scalar10 < 10; scalar10++) {
                              ...
                              int* array12 = new int[721];
                              for (int i = 0; i < 819; i++) {
                                 array11[i]--; 
                              }
                              int* array13 = new int[939];
                              for (int i = 0; i < 336; i++) {
                                 array3[i]++; 
                              }
                              if(rng() & 1) {
                                 ...
                                 int* array14 = new int[940];
                                 if(rng() & 1) {
                                    func36();
                                 }
                                 else {
                                    for(int scalar15 = 0; scalar15 < 10; scalar15++) {
                                       int* array16 = new int[667];
                                       for (int i = 0; i < 301; i++) {
                                          array7[i]++; 
                                       }
                                       int* array17 = new int[228];
                                       for (int i = 0; i < 819; i++) {
                                          array11[i]--; 
                                       }
                                       int* array18 = new int[150];
                                       for (int i = 0; i < 587; i++) {
                                          array6[i]++; 
                                       }
                                       if(rng() & 1) {
   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 2) {
         ...
         for(int scalar5 = 0; scalar5 < 10; scalar5++) {
            ...
            int* array7 = new int[22];
            for (int i = 0; i < 929; i++) {
               array6[i]--; 
            }
            int* array8 = new int[69];
            for (int i = 0; i < 929; i++) {
               array6[i]++; 
            }
            printf("DELETE!\n");
...
void func28(const unsigned long PATH0) {
   ...
   if(PATH0 & 1) {
      ...
      int* array8 = new int[313];
      if(PATH0 & 2) {
         func42();
      }
      else {
         for(int scalar9 = 0; scalar9 < 10; scalar9++) {
            int* array10 = new int[857];
            for (int i = 0; i < 84; i++) {
               array5[i]++; 
            }
            int* array11 = new int[895];
            for (int i = 0; i < 846; i++) {
               array7[i]--; 
            }
            int* array12 = new int[545];
            for (int i = 0; i < 895; i++) {
               array11[i]++; 
            }
            printf("DELETE!\n");
...
void func21(const unsigned long PATH0) {
   int* array3 = new int[178];
   for (int i = 0; i < 178; i++) {
      array3[i]++; 
   }
   int* array4 = new int[584];
   for (int i = 0; i < 584; i++) {
      array4[i]--; 
   }
   int* array5 = new int[651];
   for (int i = 0; i < 651; i++) {
      array5[i]++; 
   }
   if(PATH0 & 1) {
      ...
      int* array6 = new int[399];
      if(PATH0 & 2) {
         func36();
      }
      else {
         for(int scalar7 = 0; scalar7 < 10; scalar7++) {
            int* array8 = new int[932];
            for (int i = 0; i < 178; i++) {
               array3[i]++; 
            }
            int* array9 = new int[676];
            for (int i = 0; i < 178; i++) {
               array3[i]--; 
            }
         ...
         for(int scalar4 = 0; scalar4 < 10; scalar4++) {
            ...
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar9 = 0; scalar9 < 10; scalar9++) {
                     int* array10 = new int[601];
                     scalar4++;
                     int* array11 = new int[902];
                     scalar9--;
...
void func13(const unsigned long PATH0) {
   ...
   int* array4 = new int[301];
   for (int i = 0; i < 756; i++) {
      array3[i]++; 
   }
   int* array5 = new int[286];
   for (int i = 0; i < 301; i++) {
      array4[i]--; 
   }
   int* array6 = new int[865];
   for (int i = 0; i < 301; i++) {
      array4[i]++; 
   }
   if(PATH0 & 1) {
      ...
      int* array7 = new int[444];
      if(PATH0 & 2) {
         func30();
      }
      else {
         for(int scalar8 = 0; scalar8 < 10; scalar8++) {
            int* array9 = new int[619];
            scalar8++;
            int* array10 = new int[729];
            for (int i = 0; i < 729; i++) {
               array10[i]--; 
            }
            int* array11 = new int[117];
            for (int i = 0; i < 619; i++) {
               array9[i]++; 
            }
            if(PATH0 & 4) {
               ...
               int* array12 = new int[771];
               if(PATH0 & 8) {
                  func42();
               }
               else {
                  for(int scalar13 = 0; scalar13 < 10; scalar13++) {
                     int* array14 = new int[481];
                     for (int i = 0; i < 481; i++) {
                        array14[i]++; 
                     }
                     int* array15 = new int[709];
                     for (int i = 0; i < 619; i++) {
                        array9[i]--; 
                     }
...
void func23(const unsigned long PATH0) {
   ...
   int* array6 = new int[965];
   for (int i = 0; i < 586; i++) {
      array5[i]++; 
   }
   int* array7 = new int[683];
   for (int i = 0; i < 683; i++) {
      array7[i]--; 
   }
   ...
   if(PATH0 & 1) {
      ...
      int* array9 = new int[871];
      if(PATH0 & 2) {
         func36();
      }
      else {
         for(int scalar10 = 0; scalar10 < 10; scalar10++) {
            int* array11 = new int[732];
            for (int i = 0; i < 871; i++) {
               array9[i]++; 
            }
            int* array12 = new int[503];
            for (int i = 0; i < 624; i++) {
               array8[i]--; 
            }
...
void func16(const unsigned long PATH0) {
   int* array4 = new int[149];
   for (int i = 0; i < 149; i++) {
      array4[i]++; 
   }
   int* array5 = new int[723];
   for (int i = 0; i < 149; i++) {
      array4[i]--; 
   }
   int* array6 = new int[245];
   for (int i = 0; i < 245; i++) {
      array6[i]++; 
   }
   if(PATH0 & 1) {
      ...
      int* array7 = new int[451];
      if(PATH0 & 2) {
         func30();
      }
      else {
         for(int scalar8 = 0; scalar8 < 10; scalar8++) {
            int* array9 = new int[921];
            for (int i = 0; i < 921; i++) {
               array9[i]++; 
            }
            ...
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar13 = 0; scalar13 < 10; scalar13++) {
                     ...
                     int* array15 = new int[500];
                     for (int i = 0; i < 245; i++) {
                        array6[i]--; 
                     }
                     int* array16 = new int[764];
                     for (int i = 0; i < 245; i++) {
                        array6[i]++; 
                     }
                     printf("DELETE!\n");
...
void func17(const unsigned long PATH0) {
   if(PATH0 & 1) {
      ...
      int* array4 = new int[914];
      if(PATH0 & 2) {
         func24();
      }
      else {
         for(int scalar5 = 0; scalar5 < 10; scalar5++) {
            int* array6 = new int[987];
            for (int i = 0; i < 987; i++) {
               array6[i]++; 
            }
            int* array7 = new int[743];
            for (int i = 0; i < 743; i++) {
               array7[i]--; 
            }
            int* array8 = new int[227];
            for (int i = 0; i < 914; i++) {
               array4[i]++; 
            }
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar10 = 0; scalar10 < 10; scalar10++) {
                     int* array11 = new int[936];
                     for (int i = 0; i < 914; i++) {
                        array4[i]++; 
                     }
                     int* array12 = new int[551];
                     for (int i = 0; i < 551; i++) {
                        array12[i]--; 
                     }
...
void func9(const unsigned long PATH0) {
   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 2) {
         ...
         for(int scalar6 = 0; scalar6 < 10; scalar6++) {
            int* array7 = new int[793];
            for (int i = 0; i < 29; i++) {
               array4[i]++; 
            }
            int* array8 = new int[428];
            for (int i = 0; i < 793; i++) {
               array7[i]--; 
            }
            ...
            if(PATH0 & 4) {
               ...
               int* array10 = new int[529];
               if(PATH0 & 8) {
                  func36();
               }
               else {
                  for(int scalar11 = 0; scalar11 < 10; scalar11++) {
                     int* array12 = new int[776];
                     for (int i = 0; i < 11; i++) {
                        array9[i]++; 
                     }
                     int* array13 = new int[443];
                     for (int i = 0; i < 11; i++) {
                        array9[i]--; 
                     }
                     int* array14 = new int[613];
                     for (int i = 0; i < 776; i++) {
                        array12[i]++; 
                     }
                     if(PATH0 & 16) {
...
void func10(const unsigned long PATH0) {
   if(PATH0 & 1) {
      ...
      int* array2 = new int[840];
      if(PATH0 & 2) {
         func18();
      }
      else {
         for(int scalar3 = 0; scalar3 < 10; scalar3++) {
            int* array4 = new int[904];
            scalar3++;
            int* array5 = new int[128];
            for (int i = 0; i < 840; i++) {
               array2[i]--; 
            }
            int* array6 = new int[369];
            for (int i = 0; i < 904; i++) {
               array4[i]++; 
            }
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar8 = 0; scalar8 < 10; scalar8++) {
                     ...
                     int* array10 = new int[743];
                     scalar8--;
                     int* array11 = new int[183];
                     for (int i = 0; i < 840; i++) {
                        array2[i]++; 
                     }
                     if(PATH0 & 16) {
                        ...
                        int* array12 = new int[499];
                        if(PATH0 & 32) {
                           func42();
                        }
                        else {
                           for(int scalar13 = 0; scalar13 < 10; scalar13++) {
                              int* array14 = new int[772];
                              for (int i = 0; i < 917; i++) {
                                 array7[i]++; 
                              }
                              int* array15 = new int[644];
                              scalar8--;
                              int* array16 = new int[505];
                              for (int i = 0; i < 505; i++) {
                                 array16[i]++; 
                              }
                              printf("DELETE!\n");
...
void func1(const unsigned long PATH0) {
   ...
   int* array3 = new int[786];
   for (int i = 0; i < 786; i++) {
      array3[i]++; 
   }
   int* array4 = new int[82];
   for (int i = 0; i < 954; i++) {
      array2[i]--; 
   }
   int* array5 = new int[464];
   for (int i = 0; i < 786; i++) {
      array3[i]++; 
   }
   if(PATH0 & 1) {
      ...
      int* array6 = new int[507];
      if(PATH0 & 2) {
         func18();
      }
      else {
         for(int scalar7 = 0; scalar7 < 10; scalar7++) {
            int* array8 = new int[355];
            for (int i = 0; i < 355; i++) {
               array8[i]++; 
            }
            int* array9 = new int[348];
            for (int i = 0; i < 464; i++) {
               array5[i]--; 
            }
            int* array10 = new int[622];
            for (int i = 0; i < 464; i++) {
               array5[i]++; 
            }
            if(PATH0 & 4) {
               ...
               int* array11 = new int[299];
               if(PATH0 & 8) {
                  func30();
               }
               else {
                  for(int scalar12 = 0; scalar12 < 10; scalar12++) {
                     int* array13 = new int[343];
                     scalar12++;
                     int* array14 = new int[568];
                     for (int i = 0; i < 622; i++) {
                        array10[i]--; 
                     }
                     int* array15 = new int[422];
                     for (int i = 0; i < 786; i++) {
                        array3[i]++; 
                     }
                     if(PATH0 & 16) {
                        ...
                        int* array16 = new int[810];
                        if(PATH0 & 32) {
                           func42();
                        }
                        else {
                           for(int scalar17 = 0; scalar17 < 10; scalar17++) {
                              int* array18 = new int[605];
                              for (int i = 0; i < 507; i++) {
                                 array6[i]++; 
                              }
                              int* array19 = new int[661];
                              for (int i = 0; i < 355; i++) {
                                 array8[i]--; 
                              }
                              int* array20 = new int[878];
                              scalar12++;
                              printf("DELETE!\n");
                              printf("DELETE!\n");
                              printf("DELETE!\n");
...
void func2(const unsigned long PATH0) {
   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 2) {
         ...
         for(int scalar5 = 0; scalar5 < 10; scalar5++) {
            int* array6 = new int[282];
            for (int i = 0; i < 465; i++) {
               array3[i]++; 
            }
            int* array7 = new int[924];
            for (int i = 0; i < 465; i++) {
               array3[i]--; 
            }
            int* array8 = new int[62];
            for (int i = 0; i < 736; i++) {
               array1[i]++; 
            }
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar10 = 0; scalar10 < 10; scalar10++) {
                     ...
                     int* array12 = new int[899];
                     for (int i = 0; i < 416; i++) {
                        array4[i]--; 
                     }
                     int* array13 = new int[550];
                     for (int i = 0; i < 416; i++) {
                        array4[i]++; 
                     }
                     if(PATH0 & 16) {
                        ...
                        int* array14 = new int[71];
                        if(PATH0 & 32) {
                           func42();
                        }
                        else {
                           for(int scalar15 = 0; scalar15 < 10; scalar15++) {
                              int* array16 = new int[973];
                              for (int i = 0; i < 899; i++) {
                                 array12[i]++; 
                              }
                              int* array17 = new int[881];
                              for (int i = 0; i < 550; i++) {
                                 array13[i]--; 
                              }
                              int* array18 = new int[933];
                              for (int i = 0; i < 465; i++) {
                                 array3[i]++; 
                              }
                              printf("DELETE!\n");
...
void func12(const unsigned long PATH0) {
   int* array2 = new int[920];
   int* array3 = new int[224];
   for (int i = 0; i < 920; i++) {
      array2[i]++; 
   }
   int* array4 = new int[269];
   for (int i = 0; i < 269; i++) {
      array4[i]--; 
   }
   ...
   if(PATH0 & 1) {
      ...
      if(PATH0 & 2) {
         ...
         for(int scalar7 = 0; scalar7 < 10; scalar7++) {
            int* array8 = new int[292];
            for (int i = 0; i < 84; i++) {
               array6[i]++; 
            }
            int* array9 = new int[672];
            for (int i = 0; i < 269; i++) {
               array4[i]--; 
            }
            int* array10 = new int[625];
            for (int i = 0; i < 920; i++) {
               array2[i]++; 
            }
            if(PATH0 & 4) {
               ...
               int* array11 = new int[222];
               if(PATH0 & 8) {
                  func36();
               }
               else {
                  for(int scalar12 = 0; scalar12 < 10; scalar12++) {
                     int* array13 = new int[299];
                     for (int i = 0; i < 84; i++) {
                        array6[i]++; 
                     }
                     int* array14 = new int[42];
                     for (int i = 0; i < 84; i++) {
                        array6[i]--; 
                     }
                     int* array15 = new int[713];
                     for (int i = 0; i < 269; i++) {
                        array4[i]++; 
                     }
                     if(PATH0 & 16) {
...
void func6(const unsigned long PATH0) {
   if(PATH0 & 1) {
      ...
      int* array1 = new int[209];
      if(PATH0 & 2) {
         func11();
      }
      else {
         for(int scalar2 = 0; scalar2 < 10; scalar2++) {
            int* array3 = new int[581];
            for (int i = 0; i < 209; i++) {
               array1[i]++; 
            }
            int* array4 = new int[336];
            for (int i = 0; i < 209; i++) {
               array1[i]--; 
            }
            int* array5 = new int[155];
            for (int i = 0; i < 155; i++) {
               array5[i]++; 
            }
            if(PATH0 & 4) {
               ...
               if(PATH0 & 8) {
                  ...
                  for(int scalar7 = 0; scalar7 < 10; scalar7++) {
                     ...
                     scalar2++;
                     int* array9 = new int[273];
                     for (int i = 0; i < 273; i++) {
                        array9[i]--; 
                     }
                     int* array10 = new int[850];
                     for (int i = 0; i < 4; i++) {
                        array6[i]++; 
                     }
                     if(PATH0 & 16) {
