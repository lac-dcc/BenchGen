            ...
            for(; loop253 < loopLimit253; loop253++) {
               ...
               if(PATH0 & 64) {
                  ...
                  if(PATH0 & 128) {
                     ...
                     int loop258 = 0;
                     int loopLimit258 = (rand()%10)/4 + 1;;
                     for(; loop258 < loopLimit258; loop258++) {
                        int scalar3 = 1;
                        scalar2++;
                        int loop259 = 0;
                        int loopLimit259 = (rand()%10)/5 + 1;;
                        for(; loop259 < loopLimit259; loop259++) {
                           int loop260 = 0;
                           int loopLimit260 = (rand()%10)/6 + 1;;
                           for(; loop260 < loopLimit260; loop260++) {
                              int loop261 = 0;
                              int loopLimit261 = (rand()%10)/7 + 1;;
               ...
               if(PATH0 & 2097152) {
                  ...
                  if(PATH0 & 4194304) {
                     ...
                     for(; loop271 < loopLimit271; loop271++) {
                        ...
                        scalar2++;
                        int loop272 = 0;
                        int loopLimit272 = (rand()%10)/5 + 1;;
                        for(; loop272 < loopLimit272; loop272++) {
                           int loop273 = 0;
                           int loopLimit273 = (rand()%10)/6 + 1;;
                     ...
                     for(; loop283 < loopLimit283; loop283++) {
                        ...
                        if(PATH0 & -2147483648) {
                           ...
                           if(PATH0 & -2147483648) {
                              ...
                              int loop286 = 0;
                              int loopLimit286 = (rand()%10)/5 + 1;;
                              for(; loop286 < loopLimit286; loop286++) {
                                 int scalar7 = 1;
                                 scalar5++;
                                 int loop287 = 0;
                                 int loopLimit287 = (rand()%10)/6 + 1;;
         ...
         if(PATH0 & 32) {
            ...
            for(; loop205 < loopLimit205; loop205++) {
               ...
               for(; loop206 < loopLimit206; loop206++) {
                  int loop207 = 0;
                  int loopLimit207 = (rand()%10)/5 + 1;;
                  for(; loop207 < loopLimit207; loop207++) {
                     int loop208 = 0;
                     int loopLimit208 = (rand()%10)/6 + 1;;
         ...
         if(PATH0 & 64) {
            ...
            for(; loop360 < loopLimit360; loop360++) {
               ...
               for(; loop361 < loopLimit361; loop361++) {
                  int loop362 = 0;
                  int loopLimit362 = (rand()%10)/5 + 1;;
                  for(; loop362 < loopLimit362; loop362++) {
                     int loop363 = 0;
                     int loopLimit363 = (rand()%10)/6 + 1;;
                     for(; loop363 < loopLimit363; loop363++) {
                        int loop364 = 0;
                        int loopLimit364 = (rand()%10)/7 + 1;;
